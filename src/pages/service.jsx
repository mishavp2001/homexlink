...
export default function ServiceProfile() {
  ...
  const businessName = urlParams.get('name') ? decodeURIComponent(urlParams.get('name')) : null;
  ...
  // Lookup user email by business name
  useEffect(() => {
    const fetchUserByBusinessName = async () => {
      if (!businessName) {
        setLookupError(true);
        return;
      }
  ...
  const isLoading = !userEmail || loadingServices || loadingUser;

  if (lookupError || (!isLoading && !userEmail)) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
        ...
        <div className="py-12 px-4 flex items-center justify-center">
          <Card className="p-12 text-center max-w-md">
            ...
            <p className="text-gray-600 mb-4">We couldn't find a business with this name.</p>
            {businessName && <p className="text-sm text-gray-500">Searched for: {businessName}</p>}
          </Card>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
        ...
        <div className="py-12 px-4 flex items-center justify-center">
          <Card className="p-12 text-center max-w-md">
            ...
            <p className="text-gray-600 mb-4">This business doesn't have any active service listings yet.</p>
            {businessName && <p className="text-sm text-gray-500">Business: {businessName}</p>}
          </Card>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50">
      ...
      <div className="py-12 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          {isBusinessProfile && businessName && (
            <Card className="p-6 mb-8">
              ...
              <iframe 
                src={`${window.location.origin}/servicequote?name=${encodeURIComponent(businessName)}`}
                width="100%" 
                height="600" 
                frameBorder="0" 
