...
export default function AdminVideoGeneration() {
  ...
  const generateVideos = async () => {
    ...
    const confirmed = confirm(`Generate videos for ${selectedDeals.length} deal(s)?\n\nThis may take several minutes.`);
    if (!confirmed) return;
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Selected: <strong>{selectedDeals.length} deal(s)</strong>
                </p>
                {generating && (
              ...
              >
                {generating ? (
                  ...
                  <>
                    ...
                    Generate {selectedDeals.length} Video{selectedDeals.length === 1 ? '' : 's'}
                  </>
                )}
              </Button>
            </div>
