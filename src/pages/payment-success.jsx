        ...
        <div className="max-w-2xl mx-auto">
          {verifying ? (
            ...
            <Card className="p-12 text-center">
              ...
              ) : paymentData.paymentType === 'deal' ? (
                <>
                  <p className="text-xl text-gray-600 mb-6">
                    Service Deal Purchase Complete!
                  </p>
                  ...
                  <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-6 mb-8">
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Your service deal has been purchased. Now let's schedule your service!
                    </p>
                  </div>

                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <Link to={createPageUrl(`Deals#deal-${paymentData.dealId}?book=true`)}>
